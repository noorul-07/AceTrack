...
lobbyChapter.addEventListener('change', async (e) => {
    ...
    try {
        const res = await fetch('http://127.0.0.1:5000/get-concepts', {
            method: 'POST',
...
async function startMatchAsHost(chapter, concept, myEmail) {
    try {
        const res = await fetch('http://127.0.0.1:5000/generate-mcqs', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
...
async function loadQuestionsForConcept(lesson, concept, clickedBtn) {
    ...
    try {
        const res = await fetch('http://127.0.0.1:5000/generate-questions', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
...
submitConceptBtn.addEventListener('click', async () => {
    ...
    try {
        const res = await fetch('http://127.0.0.1:5000/evaluate-concept', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
